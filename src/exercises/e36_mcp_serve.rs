//! Exercise 36 — `aida mcp-serve`: talk to AIDA over the Model Context
...
const REQUEST: &str = r#"{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"list_requirements","arguments":{}}}"#;
...
impl Exercise for E {
    ...
    fn title(&self) -> &'static str {
        "aida mcp-serve — AIDA over the Model Context Protocol"
    }
