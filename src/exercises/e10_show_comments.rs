//! Exercise 10 — `aida show <id> --comments`. trace:STORY-15 | ai:claude
...
impl Exercise for E {
    ...
    fn title(&self) -> &'static str {
        "aida show <id> --comments — read the audit trail"
    }
    ...
    fn hint_more(&self) -> Option<&'static str> {
        Some(
            "1. FR-1 picked up a comment in exercise 08.\n\
    ...
    fn verify(&self, workspace: &Path) -> VerifyResult {
        ...
        // Read-only command — see exercise 03. The wrapper opt-in here
