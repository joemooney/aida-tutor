...
- **Keeps the branch.** This is the deliberate part. `session-work`
  and the commit you made in exercise 29 are *not* touched. Ending a
...
overrides it; you committed in exercise 29, so you don't need it here.

## What's next

That closes the sessions + worktrees cluster. Exercise 32 opens the
