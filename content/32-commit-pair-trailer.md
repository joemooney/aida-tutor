...
store on the orphan `aida-store` branch you met in exercises 19–21.
...
exercise 06 — `[AI:tool] type(scope): description (REQ-ID)`):
...
Exercise 33 — turn requirements into a review brief with `aida review
prompt`.
