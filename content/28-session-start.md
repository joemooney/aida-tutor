...
exercise 02. Confirm its id first:
...
one from the scope. We pin it here only so exercises 29-31 can follow
this exact session.

## What's next

Exercise 29 — `cd` into the worktree and do work there.
