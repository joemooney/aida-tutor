...
You're the consumer now. In exercise 23 the producer routed a task to
the implementer queue. Wearing the `implementer` hat (exercise 22), you
...
It shows the "Queue demo" task you routed in exercise 23, and even
...
never entered it (exercise 22). The queue didn't lose your task; you're
...
Exercise 25 — finish the task and clear it from the queue in one move.
